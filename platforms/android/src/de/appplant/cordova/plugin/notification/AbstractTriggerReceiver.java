...
import de.appplant.cordova.plugin.notification.AbstractClickActivity;
...
abstract public class AbstractTriggerReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        setContextForLaunchApp(context);
    ...
    public void launchApp() {
        ...
        Context context = getContextForLaunchApp();
    ...
    public void setContextForLaunchApp(Context context){
            this.context = context;
    }

    public Context getContextForLaunchApp(){
            return this.context;
    }
